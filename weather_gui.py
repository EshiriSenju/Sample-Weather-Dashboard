from PyQt5.QtWidgets import QWidget, QPushButton, QGridLayout, QLabel, QLineEdit, QMessageBox
...
class WeatherApp(QWidget):
    ...
    def fetch_weather(self):
        ...
        try:
            ...
            self.visibility_label.setText(f"Visibility: {visibility} m" if visibility != 'N/A' else "Visibility: N/A")
